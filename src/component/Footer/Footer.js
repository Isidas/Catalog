        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__wrapper">
                    <a href="#" className="footer__logo">Интерьер</a>
                    <div className="footer__info">
                        ...
                        <div className="footer__item">
                            ...
                            <a href="#" className="footer__link">+7 908 800 80 80 </a>
                            <a href="#" className="footer__link">help@interier.com</a>
                            <div className="footer__icons">
                                <a href="#"><img src={inst} alt="img" className="footer__img" /></a>
                                <a href="#"><img src={twit} alt="img" className="footer__img" /></a>
                                <a href="#"><img src={fbook} alt="img" className="footer__img" /></a>
                            </div>
                        </div>
                    </div>
                    <div className="footer__form">
                        <span className="footer__appeal">Получайте наши новости и обновления </span> 
